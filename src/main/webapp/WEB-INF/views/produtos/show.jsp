...
<body class="product">
	...
	<nav class="categories-nav">
		<ul class="container">
			...
			<li class="category">
				<a href="/collections/livros-desenvolvimento-web"><fmt:message key="navigation.category.mobile"/></a>
			</li>
			<li class="category">
	...
	<article id="${product.titulo}" itemscope itemtype="http://schema.org/Book">
		<header id="product-highlight" class="clearfix">
			<div id="product-overview" class="container">
				<img itemprop="image" width="280px" height="395px" src='http://cdn.shopify.com/s/files/1/0155/7645/products/cover-apis-java_large.jpeg?v=1423244220' class="product-featured-image" alt="${product.titulo}">
				<h1 class="product-title" itemprop="name">${product.titulo}</h1>
		...
		<div class="container">
			<section class="author product-detail" itemprop="author" itemscope itemtype="http://schema.org/Person">
				<h2 class="section-title" itemprop="name">${product.titulo}</h2>
				<span itemprop="description">
					<p class="book-description">${product.descricao}</p>
				</span>
			</section>
			...
			<section class="data product-detail">
				...
				<p>
					Número de paginas: <span itemprop="numberOfPages">${product.paginas}</span>
				</p>
